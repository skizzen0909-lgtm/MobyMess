...
- ✅ Создан BAT-файл `run_server.bat` для быстрого запуска сервера
...
*Последнее обновление: 29.08.2024*
*Статус: ~95% готовности - реализована синхронизация контактов и скрипт запуска, остаются фоновая служба и push-уведомления*
